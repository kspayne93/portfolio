               ...
               <div className='project-info-container'>
                  ...
                  <div className='project-links'>
                     <div className='live-site-link'>
                        <a target='_blank' href={project.liveSiteURL} rel="noopener noreferrer">View Live Site</a>
                        {
                     ...
                     <div className='code-link'>
                        <a target='_blank' href={project.codeURL} rel="noopener noreferrer">View Code</a>
                     </div>
                  </div>
               </div>
